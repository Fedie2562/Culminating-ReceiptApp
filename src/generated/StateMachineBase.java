...
**/
    ...
    public com.codename1.ui.TextField findCompanyName(Component root) {
        return (com.codename1.ui.TextField)findByName("CompanyName", root);
    }

    public com.codename1.ui.TextField findCompanyName() {
        com.codename1.ui.TextField cmp = (com.codename1.ui.TextField)findByName("CompanyName", Display.getInstance().getCurrent());
        if(cmp == null && aboutToShowThisContainer != null) {
            cmp = (com.codename1.ui.TextField)findByName("CompanyName", aboutToShowThisContainer);
        }
        return cmp;
    }
    ...
    public com.codename1.ui.Button findSendButton(Component root) {
        return (com.codename1.ui.Button)findByName("SendButton", root);
    }

    public com.codename1.ui.Button findSendButton() {
        com.codename1.ui.Button cmp = (com.codename1.ui.Button)findByName("SendButton", Display.getInstance().getCurrent());
        if(cmp == null && aboutToShowThisContainer != null) {
            cmp = (com.codename1.ui.Button)findByName("SendButton", aboutToShowThisContainer);
        }
        return cmp;
    }
    ...
    protected void handleComponentAction(Component c, ActionEvent event) {
        ...
        if(rootContainerName.equals("Main")) {
            if("CompanyName".equals(c.getName())) {
                onMain_CompanyNameAction(c, event);
                return;
            }
            if("Email".equals(c.getName())) {
                onMain_EmailAction(c, event);
                return;
            }
            if("Message".equals(c.getName())) {
                onMain_MessageAction(c, event);
                return;
            }
            if("SendButton".equals(c.getName())) {
                onMain_SendButtonAction(c, event);
                return;
            }
        }
    }

      protected void onMain_CompanyNameAction(Component c, ActionEvent event) {
      }

      protected void onMain_EmailAction(Component c, ActionEvent event) {
      }

      protected void onMain_MessageAction(Component c, ActionEvent event) {
      }
